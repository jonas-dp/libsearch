(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.booksService.books.subscribe(function (books) { return _this.books = books; });
                };
                AppComponent.prototype.onBookFiltersChanged = function (filters) {
            ...
            var AvailabilitiesComponent = /** @class */ (function () {
                ...
                AvailabilitiesComponent.prototype.ngOnInit = function () {
                    if (this.bookStatus === 'AVAILABLE') {
                        this.availabilities = this.availabilities.filter(function (x) { return x.is_available; });
                    }
                    this.today = new Date();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var BookFilterPipe = /** @class */ (function () {
                function BookFilterPipe() {
                }
                BookFilterPipe.prototype.transform = function (books, filters) {
                    ...
                    filters.forEach(function (filterItem, index) {
                        ...
                        filteredBooks = filteredBooks.filter(function (book) { return filterItem.filter(book); });
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var DatediffPipe = /** @class */ (function () {
                function DatediffPipe() {
                }
                DatediffPipe.prototype.transform = function (date, otherDate) {
                    if (!date || !otherDate) {
                        return;
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FilterbarComponent = /** @class */ (function () {
                ...
                FilterbarComponent.prototype.onAvailableFilterBtnClick = function () {
                    this.toggleButton(this.availableFilterBtn, 'AVAILABLE');
                };
                FilterbarComponent.prototype.onUnavailableFilterBtnClick = function () {
                    this.toggleButton(this.unavailableFilterBtn, 'UNAVAILABLE');
                };
                FilterbarComponent.prototype.onNoAvailabilitiesBtnClick = function () {
                    this.toggleButton(this.noAvailabilitiesFilterBtn, 'NO_AVAILABILITIES');
                };
                FilterbarComponent.prototype.onNotFoundBtnClick = function () {
                    this.toggleButton(this.notFoundFilterBtn, 'NOT_FOUND');
                };
                FilterbarComponent.prototype.onAllFilterBtnClick = function () {
                    this.toggleButton(this.allFilterBtn, 'ALL');
                    this.removeFilter('status');
                    this.removeFilter('ebooks');
                    this.addFilter({
                        name: 'status',
                        filter: (function (book) { return 1 === 1; })
                    });
                };
                FilterbarComponent.prototype.onEbooksFilterBtnClick = function () {
                ...
                FilterbarComponent.prototype.removeFilter = function (filterName) {
                    this.filters = this.filters.filter(function (x) { return x.name !== filterName; });
                    this.bookFiltersChanged.emit(this.filters);
                };
                FilterbarComponent.prototype.addFilter = function (filter) {
                    this.filters.push(filter);
                    this.bookFiltersChanged.emit(this.filters);
                };
                FilterbarComponent.prototype.toggleButton = function (button, status) {
                    this.removeFilter('status');
                    this.removeFilter('ebooks');
                    if (this.activeFilterBtn === button) {
                        ...
                        this.addFilter({
                            name: 'status',
                            filter: (function (book) { return book.status === status; })
                        });
                ...
                FilterbarComponent.prototype.setSearchFilter = function (query) {
                    ...
                    this.addFilter({
                        name: 'search',
                        filter: (function (book) { return book.title.toLowerCase().includes(query.toLowerCase()) || book.author.toLowerCase().includes(query.toLowerCase()); })
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(booksService) {
                    this.booksService = booksService;
                    this.libraries = '';
                }
                HeaderComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.booksService.libraries.subscribe(function (libraries) {
                        libraries.forEach(function (library, index) {
                            _this.libraries += library.name;
                            if (library.libraries) {
                                _this.libraries += " (" + library.libraries.join(', ') + ")";
                            }
            ...
            var BooksService = /** @class */ (function () {
                function BooksService(http) {
                    ...
                    this.http
                        ...
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (libsearch) {
                        var libraries = libsearch.libraries;
                        var books = libsearch.catalogue.books.map(function (jsonBook) {
                            var jsonAvails = jsonBook.availabilities;
                            var avails = jsonAvails.map(function (avail) {
                                var date = null;
                    ...
                    })).subscribe(function (libsearch) {
                        _this.libraries.next(libsearch.libraries);
                        _this.books.next(libsearch.catalogue.books);
                    });
                }
                return BooksService;
            }());
